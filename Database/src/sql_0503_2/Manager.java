...
public class Manager extends JFrame implements TreeSelectionListener {
	...
	public Manager() {
		...
		root = new DefaultMutableTreeNode("教务管理系统——教务处");



		t1 = new DefaultMutableTreeNode("学生信息管理");
		...
		t2 = new DefaultMutableTreeNode("教师信息管理");

		t2_1 = new DefaultMutableTreeNode("教师基本信息");

		t2_2 = new DefaultMutableTreeNode("教师开课信息");
